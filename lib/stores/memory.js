...
module.exports = function (config) {
    ...
    config = _.extend({
        data: [
            ...
            {id: "anne", username: "anne", password: "pwdaaa", salt: "aaa", email: "anne@example.com"}
        ]
    }, config || {});
    ...
    // we don't care if it takes some time.
    Array.prototype.forEach.call(config.data || [], function (user) {
        createUser(user, function (err, newUser) {});
    });
