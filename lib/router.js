...
module.exports = function (sanitizer, store, passwordChecker, passport, render) {
    ...
    var authorization  = require('./router/authorization')(render);
    ...
    var profile         = require('./router/profile')(sanitizer, store, passwordChecker, render);

    var router = express.Router();      // get an instance of the express Router

    // expose some utilities
    router.requireAuthentication = authentication.requireAuthentication;
    router.requireSudo           = authentication.requireSudo;
    router.resetSudo             = authentication.resetSudo;
    ...
    router.get('/me/password', authorization.requireSudo(), profile.editPassword);
    router.put('/me/password', [authorization.requireSudo(), authorization.resetSudo()].concat(profile.updatePassword));
